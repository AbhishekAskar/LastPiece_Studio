                    ...
                    <div className="lg:col-span-2 sm:col-span-6">
                        ...
                        <ul className="space-y-4">
                            {links.services.map((link, i) => (
                                <li key={i}>
                                    <a href={link.href} className="text-slate-400 hover:text-brand-purple transition-colors flex items-center gap-1 group">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="lg:col-span-2 sm:col-span-6">
                        ...
                        <ul className="space-y-4">
                            {links.company.map((link, i) => (
                                <li key={i}>
                                    <a href={link.href} className="text-slate-400 hover:text-brand-purple transition-colors">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
